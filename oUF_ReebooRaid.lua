--[[------------------------------------
	...
	Based upon oUF_Lily, oUF_Mastiff & oUF_AmnithRaid

--------------------------------------]]

--[[     files     ]]
local texture		= "Interface\\AddOns\\oUF_ReebooRaid\\textures\\statusbar"
local border		= "Interface\\AddOns\\oUF_ReebooRaid\\textures\\border"
--~ local buffborder	= "Interface\\AddOns\\oUF_ReebooRaid\\textures\\buffborder"		-- not used (yet)
local font			= "Interface\\AddOns\\oUF_ReebooRaid\\fonts\\ABF.ttf"
local overlay		= "Interface\\AddOns\\oUF_ReebooRaid\\textures\\overlay"
local mohighlight	= "Interface\\AddOns\\oUF_ReebooRaid\\textures\\highlight"
...
--[[     register style     ]]
oUF:RegisterStyle("oUF_ReebooRaid", setmetatable({
	["initial-width"] = width,
	["initial-height"] = height,
}, {__call = func}))

--[[     spawn frames     ]]
oUF:SetActiveStyle"oUF_ReebooRaid"
